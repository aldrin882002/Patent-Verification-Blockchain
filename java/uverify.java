 ...
 * @author ADMIN
 */
public class uverify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AesEncryption asc=new AesEncryption();
              System.out.println("select * from register where uid='"+b+"'");
   ResultSet rs=st.executeQuery("select * from register where uid='"+b+"'");
       if(rs!=null){
            ...
            if (request.getParameter("t1") != null) {
                ...
                System.out.println("update register set status ='Active' where uid='"+b+"'");

              
                    
                 int v1=st.executeUpdate("update register set status ='Active' where uid='"+b+"'");
                 if(v1==1){
                        //ss.SendSMS(a1,"right to Accepted ");
                         request.setAttribute("ok", "1");
                          request.setAttribute("msg", "Accepted Succesfully");
                              
                       RequestDispatcher rs2 = request.getRequestDispatcher("a2.jsp");
               ...
               String v = null;
                ...
                System.out.println("Formatted date is ==>" + f);
                    ...
                    ResultSet rs1=st1.executeQuery("select * from register where uid='"+b+"'");
			if(rs1.next())
			{
                ...
                rs2.forward(request, response);
                             ...
                             RequestDispatcher rs12 = request.getRequestDispatcher("a2.jsp");
                ...
                System.out.println("Formatted date is ==>" + f);
                 ...
                 int v1=st.executeUpdate("update register set status='Denied' where uid='"+b+"'");
                 if(v1==1){
