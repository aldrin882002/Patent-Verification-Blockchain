 ...
 * @author ADMIN
 */
public class qpost extends HttpServlet {
       ...
       if(rs!=null){
            ...
            if (request.getParameter("t1") != null) {
                ...
                System.out.println("update patentapply set ack1 ='Accept' where pid='"+b+"'");
                 ...
                 int v1=st.executeUpdate("update patentapply set ack ='Accept',uname='"+so.getAttribute("un")+"',ddates='"+f+"' where pid='"+b+"'");
                 if(v1==1){
...
sdf = new SimpleDateFormat("yyyy-M-dd");
 f11=sdf.format(date);
    int sts=st1.executeUpdate("insert into pblock values('"+firstBlock.hashCode()+"','"+transaction1+"','Accept','"+b+"','"+so.getAttribute("un")+"','"+f11+"','Quality Check')");

                        //ss.SendSMS(a1,"right to Accepted ");
                         request.setAttribute("ok", "1");
                          request.setAttribute("msg", "Accepted Succesfully");
                              
                       RequestDispatcher rs2 = request.getRequestDispatcher("d3.jsp");
			...
			if(rs1.next())
			{
                ...
                rs2.forward(request, response);
                             ...
                             RequestDispatcher rs12 = request.getRequestDispatcher("d3.jsp");
                ...
                System.out.println("Formatted date is ==>" + f);
                 ...
                 int v1=st.executeUpdate("update patentapply  set ack='Denied',uname='"+so.getAttribute("un")+"',ddates='"+f+"' where pid='"+b+"'");
                 if(v1==1){
...
sdf = new SimpleDateFormat("yyyy-M-dd");
 f11=sdf.format(date);
    int sts=st1.executeUpdate("insert into pblock values('"+firstBlock.hashCode()+"','"+transaction1+"','Denied','"+b+"','"+so.getAttribute("un")+"','"+f11+"','Quality Check')");
