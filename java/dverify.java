    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            AesEncryption asc=new AesEncryption();
              System.out.println("select * from dregister where oid='"+b+"'");
   ResultSet rs=st.executeQuery("select * from dregister where oid='"+b+"'");
       if(rs!=null){
            ...
            if (request.getParameter("t1") != null) {
                ...
                System.out.println("update dregister set status ='Active' where oid='"+b+"'");

              
                    
                 int v1=st.executeUpdate("update dregister set status ='Active' where oid='"+b+"'");
                 if(v1==1){
                        //ss.SendSMS(a1,"right to Accepted ");
                         request.setAttribute("ok", "1");
                          request.setAttribute("msg", "Accepted Succesfully");
                              
                       RequestDispatcher rs2 = request.getRequestDispatcher("a4.jsp");
                ...
                System.out.println("Formatted date is ==>" + f);
                 ...
                 int v1=st.executeUpdate("update dregister set status='Denied' where uid='"+b+"'");
                 if(v1==1){
